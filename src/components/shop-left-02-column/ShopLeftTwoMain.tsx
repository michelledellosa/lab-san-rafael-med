...
import ShopLeftTabProductsOne from './ShopLeftTabProductsOne';
import ShopLeftTabProductsTwo from './ShopLeftTabProductsTwo';

const ShopLeftTwoMain = () => {
    const selectHandler = () => { }
    return (
        <>
                                ...
                                <div className="product-tab-content">
                                    <div className="tab-content" id="myTabContent">
                                        <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            <div className="row">
                                                <ShopLeftTabProductsOne />
                                            </div>
                                        </div>
                                        <div className="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                            <ShopLeftTabProductsTwo />
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
...
export default ShopLeftTwoMain;