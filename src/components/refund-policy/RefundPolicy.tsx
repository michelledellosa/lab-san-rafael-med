            ...
            <div className="terms_conditions_content">
                ...
                <ul className="icon_list unordered_list_block">
                    <li> <span className="list_item_text">
                        1. To be eligible for a refund, the product must be in its original condition, unused, and in its original packaging. </span>
                    </li>
                ...
                <ul className="icon_list unordered_list_block">
                    <li>
                        <span className="list_item_text">
                            Medibazar reserves the right to update or modify this refund policy at any time without prior notice. Any changes will be effective immediately upon posting on our website.
                        </span>
                    </li>
                </ul>
                <p>If you have any questions or concerns regarding our product refund policy, please do not hesitate to contact our customer support team. We are here to assist you and ensure that you have a positive shopping experience with us.
                    Thank you for choosing Medibazar!</p>
