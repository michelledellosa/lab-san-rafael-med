...
import BlogBg from '../../../public/assets/img/bg/03.jpg';

const BlogAreaThree = () => {
    return (
        <>
            <div className="blog-area pt-105 pb-75 blog-2" style={{ backgroundImage: `url(${BlogBg.src})` }}>
                <div className="container">
                    <div className="row">
                        <div className="col-xl-6 col-lg-6 offset-lg-3 offset-xl-3">
                            <div className="section-title text-center mb-65">
                                <h2>Latest News & Blog</h2>
                                <p>Stay informed and empowered with our Latest News & Blog in medical equipment</p>
                            </div>
                        </div>
                    </div>
                    <div className="row">
