...
import ShopRightTabOneProducts from './ShopRightTabOneProducts';
import ShopRightTabTwoProducts from './ShopRightTabTwoProducts';

const ShopRightSidebarMain = () => {
    const selectHandler = () => { }

    return (
        <>
            <Breadcrumb title='Shop Right' subTitle='Shop' />
            <div className="sh0p-area pt-100 pb-70">
                                ...
                                <div className="product-tab-content">
                                    <div className="tab-content" id="myTabContent">
                                        <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            <div className="row">
                                                <ShopRightTabOneProducts />
                                            </div>
                                        </div>
                                        <div className="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                            <ShopRightTabTwoProducts />
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
...
export default ShopRightSidebarMain;